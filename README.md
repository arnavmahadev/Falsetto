...
glance: structured music shows repeated blocks/diagonals, while drifting or unstructured audio
doesn't.
...
> *proxy*: structured music (real recordings plus synthetic loops) versus drifting or
> unstructured audio. It is **illustrative only**. The visualizations, though, are computed for
> real on your audio. Point `falsetto train` at the datasets for a validated detector.
